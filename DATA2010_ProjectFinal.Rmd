...
We moved to attempt Lasso regression to yet again try and improve our models. When performing lasso regression on the 4 original variables that all had RMSE under 8, this is what we got.

**Lasso regression** = 7.968656  

This is a good RMSE values but it is not lower than any 1 of the 4 original RMSE values gained from using linear regression.
