...
# Do regression on like gender and age and alc consumption and family history etc. OR maybe do regression n all variables but just do a bunch of different types of regression.
```
