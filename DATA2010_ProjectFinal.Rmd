...
In this paper we investigate different models that can be used to predict obesity levels based on other variables other than height and weight. The models will be based on the following variables.
